...
public class RayCasting {
    ...
    private static void detectBlocks(ServerPlayerEntity bot) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            ChatUtils.sendChatMessages(bot.getCommandSource().withSilent().withPermissions(net.wcfcarolina13.Frens.OPERATOR_PERMISSIONS), "Block detected in front at " + hitResult.getBlockPos().getX() + ", " + hitResult.getBlockPos().getY() + ", " + hitResult.getBlockPos().getZ());
            ...
            ChatUtils.sendChatMessages(bot.getCommandSource().withSilent().withPermissions(net.wcfcarolina13.Frens.OPERATOR_PERMISSIONS), "No block detected in front");
        }
