...
public class Frens implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        net.wcfcarolina13.network.GroupChatHint.register();
        ...
        // types and server receivers; the client receiver is registered at client init by FrensClient).
        ...
        net.wcfcarolina13.GameAI.services.supply.SupplyRequestService.register();
        net.wcfcarolina13.Commands.SupplyCommands.register();
        try {
            SQLiteDB.createDB();
        } catch (Exception e) {
