...
import net.wcfcarolina13.ChatUtils.ChatContextManager;
import net.wcfcarolina13.ChatUtils.ConfirmationState;
...
import net.wcfcarolina13.GameAI.llm.LLMJobTracker;
import net.wcfcarolina13.GameAI.llm.LLMActionQueue;
...
import net.wcfcarolina13.Database.OldSQLiteDB;
import net.wcfcarolina13.Entity.AutoFaceEntity;
import net.wcfcarolina13.Entity.LookController;
import net.wcfcarolina13.Overlay.ThinkingStateManager;
...
import net.wcfcarolina13.WebSearch.WebSearchTool;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import static net.wcfcarolina13.ChatUtils.Helper.JsonUtils.cleanJsonString;
...
public class FunctionCallerV2 {
    ...
    private static String selectedLM = Frens.CONFIG.getSelectedLanguageModel();
    ...
    private static void deliverConversation(String reply) {
        ...
        ChatUtils.sendChatMessages(currentBotSource().withSilent().withPermissions(net.wcfcarolina13.Frens.OPERATOR_PERMISSIONS), reply.trim());
    }
