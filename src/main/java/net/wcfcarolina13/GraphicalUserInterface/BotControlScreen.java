...
public class BotControlScreen extends Screen {
    ...
    protected void init() {
        ...
        List<String> aliases = new ArrayList<>(Frens.CONFIG.getBotGameProfile().keySet());
    ...
    private Row buildRow(String alias) {
        ManualConfig.BotControlSettings settings = Frens.CONFIG.getOrCreateBotControl(alias);
