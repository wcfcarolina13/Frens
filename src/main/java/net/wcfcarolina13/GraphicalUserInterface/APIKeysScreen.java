...
public class APIKeysScreen extends Screen {
    ...
    protected void init() {
        ...
        openAIKeyField.setText(Frens.CONFIG.getOpenAIKey());
        ...
        claudeKeyField.setText(Frens.CONFIG.getClaudeKey());
        ...
        geminiKeyField.setText(Frens.CONFIG.getGeminiKey());
        ...
        grokKeyField.setText(Frens.CONFIG.getGrokKey());
        ...
        customApiUrlField.setText(Frens.CONFIG.getCustomApiUrl());
        ...
        customApiKeyField.setText(Frens.CONFIG.getCustomApiKey());
    ...
    private void saveToFile() {
        Frens.CONFIG.setOpenAIKey(this.openAIKeyField.getText());
        Frens.CONFIG.setClaudeKey(this.claudeKeyField.getText());
        Frens.CONFIG.setGeminiKey(this.geminiKeyField.getText());
        Frens.CONFIG.setGrokKey(this.grokKeyField.getText());
        Frens.CONFIG.setCustomApiKey(this.customApiKeyField.getText());
        Frens.CONFIG.setCustomApiUrl(this.customApiUrlField.getText());
        Frens.CONFIG.save();

        String llmMode = System.getProperty("frens.llmMode", System.getProperty("aiplayer.llmMode", "ollama"));
        switch (llmMode) {
