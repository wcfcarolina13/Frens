package net.wcfcarolina13.ChatUtils.Helper;
...
public class RAG2 {
    ...
    private static OllamaAPI createOllamaApi() {
        String baseUrl = (Frens.CONFIG != null)
    ...
    public static void run(String userPrompt, ServerCommandSource botSource, NLPProcessor.Intent intent) {
        ...
        if (Frens.CONFIG != null && Frens.CONFIG.getLlmMode() != null && !Frens.CONFIG.getLlmMode().isBlank()) {
            provider = Frens.CONFIG.getLlmMode();
        } else {
            provider = System.getProperty("frens.llmMode", System.getProperty("aiplayer.llmMode", "ollama"));
        }
