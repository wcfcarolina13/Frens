...
public final class BotDialoguePlayer {
    ...
    private static void initializeSubtitles() {
        ...
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_AMBIENT_TEETH_ITCH, "My teeth itch!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_ANIMAL_NEARBY_LOVE_ANIMALS, "I love animals.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_PARROT_NEARBY_NICE_BIRD, "Nice bird.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_HORSE_NEARBY_NICE_HORSE, "Nice horse.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CAMEL_NEARBY_NICE_CAMEL, "Nice camel.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WOLF_NEARBY_GOOD_DOG, "Good dog.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WOLF_NEARBY_LOVE_DOGS, "I love dogs.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WOLF_NEARBY_SKINWALKER, "Are you sure it's not a skinwalker?");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_BERRY_BUSH_OUCH, "Ouch!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_BERRY_BUSH_YOWCH, "Yowch!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_BERRY_BUSH_EDIBLE_I_THINK, "These are edible... I think.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_BERRY_BUSH_THORNY, "These are thorny!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CREEPY_PLACE_HEARD_THAT, "I heard that. I hate that I heard that.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CREEPY_PLACE_IM_FINE_PROBABLY, "I'm fine. Probably.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CREEPY_PLACE_PRETEND_DIDNT_SEE, "I'll pretend I didn't see that.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CREEPY_PLACE_SAW_NOTHING, "I saw nothing.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CREEPY_PLACE_SHOULDNT_BE_HERE, "This place has strong 'we shouldn't be here' energy.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CREEPY_PLACE_WE_CAN_RECOVER, "We can recover.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_CREEPY_PLACE_WIN_OR_LEAVE, "We can win this. Or we can leave. I'm flexible.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_ENDERMAN_SPOTTED_DONT_LOOK, "Don't look at it.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_FOLIAGE_STUCK_CANT_GET_THROUGH, "Can't get through these leaves.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_FOLIAGE_STUCK_GOT_ME, "Just a sec… foliage's got me.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_FOLIAGE_STUCK_IN_BRANCHES, "Hold on — stuck in some branches.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_FOLIAGE_STUCK_BRANCHES_THICK, "These branches are thick!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_I_HIT_PLAYER_ACCIDENT, "Accident, my bad!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_I_HIT_PLAYER_MUST_HAVE_HURT, "Sorry, that must have hurt!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_I_HIT_PLAYER_MY_BAD, "My bad!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_I_HIT_PLAYER_NOT_ON_PURPOSE, "That wasn't on purpose!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_I_HIT_PLAYER_OOPS_SORRY, "Oops, sorry!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_I_HIT_PLAYER_SORRY, "Sorry!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_INTENSE_COMBAT_POINT_ME_AT_PROBLEM, "I'm ready. Point me at the problem.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_INTENSE_COMBAT_THRIVING_IN_TERRIBLE, "Look at us. Absolutely thriving in terrible conditions.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_INTENSE_COMBAT_TRYING_TO_KILL_US, "Alright! Something's trying to kill us. Love that for us.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_PLAYER_HIT_ME_FRIENDLY_FIRE, "Friendly fire!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_PLAYER_HIT_ME_LOOK_OUT, "Look out!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_PLAYER_HIT_ME_QUIT_IT, "Quit it!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_PLAYER_HIT_ME_STOP_THAT, "Hey, stop that!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_PLAYER_HIT_ME_THAT_HURT, "Hey, that hurt!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_PLAYER_HIT_ME_WATCH_WHERE, "Watch where you point that!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_POST_COMBAT_WASNT_AWESOME, "Tell me that wasn't awesome. Tell me.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_POST_EXPLOSION_EXACTLY_HOW_IT_WENT, "That went... exactly how it went.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_SHELTER_BUILT_ALMOST_SOUND, "I'm proud of us. This is almost structurally sound.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_SHELTER_BUILT_INTENTIONAL, "If anyone asks, this was intentional.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_SHELTER_BUILT_RECTANGLE, "Aesthetic update. We live in a rectangle.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_SHELTER_BUILT_RESOURCES_LIMITED, "We call this style. Resources were limited.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_TIME_SUNSET_SOON_01, "Sun's going down soon.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_TIME_SUNSET_SOON_02, "Getting late. We should find shelter.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_TIME_SUNSET_SOON_03, "Night's coming.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_TIME_SUNSET_SOON_04, "We don't have much daylight left.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_TIME_SUNSET_SOON_05, "Sunset soon. Where's our bed?");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_TIME_SUNSET_SOON_06, "Better wrap up before dark.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_RAIN_01, "It's starting to rain.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_RAIN_02, "Rain's coming down.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_RAIN_03, "Getting wet out here.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_RAIN_04, "Hope this clears up soon.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_RAIN_05, "At least it's not snow.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_RAIN_06, "The rain feels nice, actually.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SNOW_01, "Snow's falling.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SNOW_02, "It's snowing out here.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SNOW_03, "Cold. Very cold.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SNOW_04, "Bundle up. It's snowing.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SNOW_05, "Snow everywhere. Beautiful, but cold.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SNOW_06, "I can barely see through this snow.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SUNNY_01, "Sun's out again.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SUNNY_02, "Clear skies. Nice.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SUNNY_03, "Finally, some sunshine.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SUNNY_04, "Weather cleared up.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SUNNY_05, "Good day for exploring.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_SUNNY_06, "Much better without the rain.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_THUNDER_01, "Thunder! Find cover!");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_THUNDER_02, "Storm's rolling in.");
        SUBTITLE_MAP.put(BotDialogueSounds.LINE_WEATHER_THUNDER_03, "Thunderstorm. Stay low.");
