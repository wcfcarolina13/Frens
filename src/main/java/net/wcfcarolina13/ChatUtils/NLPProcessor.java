...
import net.wcfcarolina13.ChatUtils.CART.CartClassifier;
import net.wcfcarolina13.ChatUtils.DecisionResolver.DecisionResolver;
import net.wcfcarolina13.ChatUtils.LIDSNetModel.LIDSNetModelManager;
import net.wcfcarolina13.ChatUtils.PreProcessing.NLPModelSetup;
import net.wcfcarolina13.ChatUtils.PreProcessing.OpenNLPProcessor;
...
public class NLPProcessor {
    ...
    public static void ensureLocalNLPModel() {
        ...
        Path modelDir = configDir.resolve("frens/NLPModels");
    ...
    public static Intent getIntention(String userPrompt) {
        ...
        if (Frens.modelManager != null && Frens.isDjlAvailable()) {
            try {
                Classifications intent = Frens.modelManager.predict(userPrompt);
                if (intent != null) {
