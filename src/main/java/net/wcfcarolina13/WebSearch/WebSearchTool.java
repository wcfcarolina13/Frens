package net.wcfcarolina13.WebSearch;
...
public class WebSearchTool {
    ...
    private static String llmMode = System.getProperty("frens.llmMode", System.getProperty("aiplayer.llmMode", "ollama"));
    ...
    private static String geminiSearch(String query) {
        try {
            String apiKey = Frens.CONFIG.getGeminiKey();
