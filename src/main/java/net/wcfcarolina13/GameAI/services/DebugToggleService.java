...
public final class DebugToggleService {
    ...
    private static final String ENV_VERBOSE = "FRENS_DEBUG";
    private static final String PROP_VERBOSE = "frens.debug";
    private static final String PROP_VERBOSE_ALT = "aiplayer.debug";
     ...
     * Enable via env `FRENS_DEBUG=true` or system property `frens.debug=true`.
     */
