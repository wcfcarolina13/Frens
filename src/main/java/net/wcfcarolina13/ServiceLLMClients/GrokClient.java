...
public class GrokClient implements LLMClient {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger("Grok-Client");

    public GrokClient(String apiKey, String modelName) {
        this.apiKey = apiKey;
    ...
    public String sendPrompt(String systemPrompt, String userPrompt) {
        try {
            ...
            LOGGER.error("Error in Grok Client: {}", e.getMessage());
            return "Error: " + e.getMessage();
        }
    }

    /**
     * Checks if the Grok API is reachable and the key is valid by making a
